                        ...
                        {recepts.map(recept => (
                            <li className="section__item" key={recept.id}>
                                ...
                                <div className="section__item-btn-section">
                                    <Link to="/shopinglist" className="section__item-btn" onClick={() => this.props.setShopingListActiveItem(recept)} >Stwórz listę zakupów</Link>
                ...
                <div className="section__right-side">
                    {this.state.showRecept ?
                        (this.state.activeRecept === -1 ?
                            <CreateRecept serverAdress={this.props.serverAdress} upgradeRecepts={this.props.upgradeRecepts} products={this.props.products} id={this.props.recepts.length} handleHideRightSite={this.handleHideRightSite.bind(this)} />
