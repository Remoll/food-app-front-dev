                ...
                <div className="section__right-side">
                    {this.state.showMenu ?
                        (this.state.activeMenu === -1 ?
                            <CreateMenu serverAdress={this.props.serverAdress} handleHideRightSite={this.handleHideRightSite} upgradeMenus={this.props.upgradeMenus} menus={this.props.menus} recepts={this.props.recepts} />
